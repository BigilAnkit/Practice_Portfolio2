                ...
                <div className=''>
                    ...
                    <div>
                        ...
                        <p className='mt-[1.2rem] text-[15px] md:text-[17px] text-[#c4cfde]'>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis, esse necessitatibus! Hic voluptatem nisi excepturi, voluptate, quas reprehenderit doloribus soluta necessitatibus expedita eius officia quidem at minima dolorem aspernatur iusto?
                        </p>
